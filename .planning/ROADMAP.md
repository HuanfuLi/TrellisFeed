...
**Depends on:** Phase 35
**Plans:** 6/6 original + 3 gap-closure plans (06 in-flight, 07 complete, 08 in-flight)
...
- [ ] 36-06-cold-start-warm-start-PLAN.md — Warm-start guard on HomeScreen cold-start useEffect: functional setDailyPosts + conditional setGenerationError so yesterday's leftover posts persist when getDailyPosts returns [] on a new day (Wave 1; gap_closure; closes GAP-A blocker from 36-UAT.md)
