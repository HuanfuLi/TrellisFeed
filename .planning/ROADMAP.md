...
- [ ] 31-06-PLAN.md — Inline video + ScrollToTopFAB + warm start + botanical loading (Wave 4)
- [ ] 31-07-PLAN.md — PostHistoryScreen + route + history recording + UAT checkpoint (Wave 5)
