...
- **D-04:** Field inventory to protect (confirm exact storage during research): tags/collections (`trellis_collections_v1`), engagement signals saved/liked/dismissed/savedPodcasts (`trellis_engagement_v1`), graph correction logs (`trellis_graph_edit_log`). "history" = engagement save/liked/post-history; researcher should pin the precise history surface.
