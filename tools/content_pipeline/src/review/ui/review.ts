...
async function render() {
  try {
    ...
    for (const candidate of queue) {
      ...
      article.append(show('Mechanical quality and duplicate evidence', { quality: candidate.mechanicalQuality || 'Unavailable', duplicateGroup: candidate.duplicateEvidence || 'Unavailable' }));
